...
import { 
  ...
  Send, Calendar, Timer, Printer, Info, Check
} from 'lucide-react';
...
const SourcingModalV3 = ({ isOpen, onClose, product }: { isOpen: boolean, onClose: () => void, product: any }) => {
            ...
            <div className="bg-white rounded-[3.5rem] shadow-2xl w-full max-w-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="p-10 border-b border-gray-100 flex justify-between items-center bg-white">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <h2 className="text-3xl font-black text-gray-900 uppercase tracking-tight leading-none">SOURCING: {product.name}</h2>
                ...
                <div className="p-10 space-y-10 bg-white overflow-y-auto max-h-[70vh] custom-scrollbar">
                    {/* SECTION 1: SUPPLY SOURCE */}
                    <div className="space-y-4">
                        <h3 className="text-xs font-black text-gray-400 uppercase tracking-[0.2em] flex items-center gap-2">
                           <Store size={16}/> 1. SELECT LIVE SUPPLY SOURCE
                        </h3>
                        <div className="p-6 bg-white border-4 border-indigo-600 rounded-[2rem] flex items-center justify-between shadow-xl shadow-indigo-50">
                            <div className="flex items-center gap-5">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            <div className="space-y-3">
                                ...
                                <input 
                                    type="number" 
                                    className="w-full p-6 bg-gray-50 border-2 border-gray-50 rounded-3xl font-black text-3xl text-gray-900 outline-none focus:bg-white focus:border-indigo-600 transition-all shadow-inner-sm"
                                    value={vol}
                        ...
                        <div className="space-y-3">
                            ...
                            <input 
                                ...
                                className="w-full p-6 bg-gray-50 border-2 border-gray-50 rounded-3xl font-bold text-lg text-gray-900 outline-none focus:bg-white focus:border-indigo-600 transition-all shadow-inner-sm"
                                value={time}
                ...
                <div className="p-10 border-t border-gray-100 bg-gray-50/50 flex gap-4 shrink-0">
                    <button onClick={onClose} className="flex-1 py-6 bg-white border-2 border-gray-100 text-gray-400 rounded-3xl font-black uppercase text-xs tracking-widest hover:bg-white hover:border-gray-200 transition-all">CANCEL</button>
                    <button 
                        onClick={handleSend}
                        disabled={isSending}
                        className="flex-[2] py-6 bg-[#8FA18F] hover:bg-[#043003] text-white rounded-3xl font-black text-xs uppercase tracking-[0.2em] shadow-xl flex items-center justify-center gap-4 transition-all disabled:opacity-50"
                    >
...
const ZapIcon = ({ size = 24, ...props }: any) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 14.5A4.5 4.5 0 0 0 8.5 19h10a3.5 3.5 0 0 0 0-7c-.5 0-1 0-1.5.5V11a5 5 0 0 0-10 0V11a4.5 4.5 0 0 0-3 3.5Z"/><path d="m9 13 2 2 4-4"/></svg>
);
...
export const Dashboard: React.FC<DashboardProps> = ({ user }) => {
  ...
  const handleAcceptOrder = (e: React.MouseEvent, orderId: string) => {
    ...
    loadData();
    alert("Order Accepted! It is now in the processing queue.");
  };
  ...
  return (
    <div className="animate-in fade-in duration-500 min-h-screen pb-20 bg-[#F8FAFC]">
      ...
      <div className="mb-10 px-2 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
            <h1 className="text-[42px] font-black text-black tracking-tighter uppercase leading-none">Partner Operations</h1>
            <div className="flex items-center gap-4 mt-2">
                ...
                <div className="ml-4 bg-gray-100 p-1 rounded-lg flex border border-gray-200 shadow-sm">
        ...
        <button 
            ...
            className="px-8 py-4 bg-blue-600 text-white rounded-xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-blue-500/20 flex items-center gap-3 active:scale-95 transition-all"
        >
        ...
        <div className="space-y-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 px-2">
                {[
                    ...
                    <div key={idx} className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col justify-between h-40">
                        <p className="text-[10px] font-black text-black opacity-40 uppercase tracking-widest">{kpi.label}</p>
                        <div className="flex justify-between items-end">
                            <h3 className="text-4xl font-black text-black tracking-tighter leading-none">{kpi.value}</h3>
                            <div className={`p-3 ${kpi.bg} ${kpi.color} rounded-2xl`}><kpi.icon size={24} /></div>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 px-2">
                ...
                <div className="w-full lg:w-[380px] bg-white rounded-[3rem] border border-gray-100 shadow-sm p-10 flex flex-col gap-10 h-fit">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-black text-gray-900 uppercase tracking-tight leading-none">Demand Matrix</h2>
                            ...
                            <div key={idx} className="space-y-4 group">
                                <div className="flex justify-between items-start">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-sm font-black text-gray-900 uppercase leading-none mb-1">{item.name}</h4>
                                            <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest">{item.variety}</p>
                                        </div>
                                    </div>
                                    <button 
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="bg-gray-50/50 p-4 rounded-2xl border border-gray-100">
                                        ...
                                        <p className="text-sm font-black text-gray-900">{item.onHand}kg</p>
                                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    {item.onHand < item.demand && (
                                        <button 
                                            onClick={() => setSourcingProduct(item)}
                                            className="flex items-center gap-1.5 text-[#F44336] hover:opacity-80 transition-colors animate-pulse w-full text-left font-black uppercase text-[9px] tracking-widest"
                                        >
                ...
                <div className="flex-1 bg-white rounded-[3.5rem] border border-gray-100 shadow-sm overflow-hidden flex flex-col min-h-[700px]">
                    <div className="p-10 border-b border-gray-100 flex flex-col xl:flex-row justify-between items-center gap-8 bg-gray-50/30 shrink-0">
                        <div className="flex items-center gap-5">
                            <div className="w-14 h-14 bg-white rounded-2xl border border-gray-200 flex items-center justify-center text-gray-900 shadow-md"><History size={28}/></div>
                            <div>
                                <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tight leading-none">Fulfillment Pipeline</h2>
                        ...
                        <div className="bg-gray-100 p-1.5 rounded-2xl flex gap-1 border border-gray-200 shadow-inner-sm overflow-x-auto no-scrollbar w-full md:w-auto">
                            {[
                                ...
                                <button 
                                    ...
                                    className={`px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-3 whitespace-nowrap ${orderSubTab === tab.id ? 'bg-white text-gray-900 shadow-md' : 'text-gray-400 hover:text-gray-600'}`}
                                >
                    ...
                    <div className="flex-1 overflow-y-auto p-10 custom-scrollbar space-y-6">
                        {currentSellingList.length === 0 ? (
                            ...
                            return (
                                <div key={order.id} className={`bg-white rounded-[3rem] border transition-all overflow-hidden ${isExpanded ? 'border-indigo-400 shadow-2xl' : 'border-gray-100 hover:border-blue-200 shadow-sm'}`}>
                                    {/* HEADER ROW (MATCHES SCREENSHOT) */}
                                    <div 
                                        onClick={() => setExpandedOrderId(isExpanded ? null : order.id)}
                                        className="p-8 flex flex-col lg:flex-row justify-between items-center gap-8 cursor-pointer group"
                                    >
                                        <div className="flex items-center gap-8 flex-1 w-full">
                                            <div className="w-16 h-16 rounded-[1.75rem] bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center font-black text-2xl shadow-inner-sm uppercase shrink-0">
                                                {buyer?.businessName.charAt(0)}
                                            </div>
                                            <div className="min-w-0">
                                                <h4 className="text-2xl font-black text-gray-900 uppercase tracking-tight leading-none mb-3 truncate group-hover:text-indigo-600 transition-colors">{buyer?.businessName}</h4>
                                                <div className="flex items-center gap-6">
                                                    <span className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest border ${order.status === 'Pending' ? 'bg-orange-50 text-orange-600 border-orange-100' : 'bg-blue-50 text-blue-600 border-blue-100'}`}>{order.status}</span>
                                        ...
                                        <div className="flex items-center gap-10 w-full lg:w-auto justify-between lg:justify-end">
                                            ...
                                            {order.status === 'Pending' ? (
                                                <button 
                                                    ...
                                                    className="px-14 py-6 bg-[#043003] text-white rounded-[1.5rem] font-black text-xs uppercase tracking-[0.2em] shadow-xl hover:bg-black transition-all active:scale-[0.98]"
                                                >
                                                    ACCEPT ORDER
                                                </button>
                                            ) : (
                                    ...
                                    {isExpanded && (
                                        <div className="p-10 bg-gray-50/50 border-t border-gray-100 animate-in slide-in-from-top-4 duration-300">
                                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                                                        ...
                                                        <table className="w-full text-left">
                                                            ...
                                                            <tbody className="divide-y divide-gray-50">
                                                                {order.items.map((item, idx) => {
                                                                    ...
                                                                    return (
                                                                        <tr key={idx}>
                                                                            <td className="px-6 py-4 font-black text-gray-900 uppercase text-xs truncate max-w-[150px]">{p?.name || 'Produce Item'}</td>
                                                                            <td className="px-6 py-4 text-center font-black text-gray-900 text-xs">{item.quantityKg}kg</td>
                                                                            <td className="px-6 py-4 text-right font-black text-gray-900 text-xs">${(item.quantityKg * item.pricePerKg).toFixed(2)}</td>
                                                                        </tr>
                                                                    );
                                                                })}
                                                            </tbody>
                                                ...
                                                <div className="space-y-8">
                                                    {/* PACKING ASSIGNMENT */}
                                                    <div className="space-y-3">
                                                        <label className="block text-[11px] font-black text-gray-900 uppercase tracking-[0.2em] ml-1">ASSIGN PACKING</label>
                                                        <div className="relative group">
                                                            <div className="absolute inset-0 bg-blue-100/50 rounded-2xl blur-sm opacity-0 group-focus-within:opacity-100 transition-opacity"></div>
                                                            <select 
                                                                className="relative w-full p-5 bg-white border-4 border-[#87CEFA] rounded-[1.25rem] font-black text-gray-900 uppercase text-xs outline-none shadow-xl transition-all focus:ring-4 focus:ring-blue-100/50 appearance-none"
                                                            ...
                                                            >
                                                                ...
                                                                {packers.map(p => <option key={p.id} value={p.name} className="font-black text-gray-900 uppercase">{p.name}</option>)}
                                                            </select>
                                                            <ChevronDown className="absolute right-5 top-1/2 -translate-y-1/2 text-blue-400 pointer-events-none" size={24} strokeWidth={3}/>
                                                        </div>
                                                    </div>

                                                    <div className="flex gap-4">
                                                        <button 
                                                            className="flex-1 py-5 bg-white border-2 border-gray-200 text-gray-900 rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] hover:bg-gray-100 transition-all flex items-center justify-center gap-2"
                                                        >
                                                            <Printer size={16}/> Print Slip
                                                        </button>
                                                        <button 
                                                            className="flex-1 py-5 bg-indigo-600 text-white rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] shadow-xl hover:bg-indigo-700 transition-all flex items-center justify-center gap-2"
                                                        >
